...
act_propose_trade_goods(game::Game, board::Board, player::PlayerType, coords::Union{Vector, Nothing}, trade_amount_flag::Int, resources::Union{Vector, Nothing}, card = nothing) = @safeact Trading.propose_trade_goods(board, game.players, player, trade_amount_flag, resources...)
